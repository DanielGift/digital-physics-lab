...
export const ScaleIcon = () => (
  <svg width="50" height="40" viewBox="0 0 50 40">
    <defs>
      <linearGradient id="scaleg" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stopColor="#e8e8f0"/>
        <stop offset="100%" stopColor="#c8c8d0"/>
      </linearGradient>
    </defs>
    {/* Base */}
    <rect x="5" y="28" width="40" height="10" rx="2" fill="url(#scaleg)" stroke="#999" strokeWidth="0.5"/>
    {/* Platform */}
    <rect x="8" y="22" width="34" height="6" rx="1" fill="#d0d0d8" stroke="#aaa" strokeWidth="0.5"/>
    {/* Display */}
    <rect x="15" y="30" width="20" height="6" rx="1" fill="#1a2a1a" stroke="#333" strokeWidth="0.5"/>
    <text x="25" y="35" textAnchor="middle" fill="#4f8" fontSize="5" fontFamily="monospace">0.000</text>
    {/* Buttons */}
    <circle cx="12" cy="33" r="1.5" fill="#666"/>
    <circle cx="38" cy="33" r="1.5" fill="#666"/>
  </svg>
);

export const RodStandIcon = () => (
  <svg width="40" height="50" viewBox="0 0 40 50">
    {/* Base */}
    <rect x="5" y="44" width="30" height="4" rx="1" fill="#4a4a52" stroke="#333" strokeWidth="0.5"/>
    {/* Vertical rod */}
    <rect x="18" y="6" width="4" height="38" fill="#888" stroke="#666" strokeWidth="0.3"/>
    <rect x="18.5" y="6" width="1.5" height="38" fill="rgba(255,255,255,0.2)"/>
    {/* Clamp */}
    <rect x="12" y="8" width="16" height="8" rx="1.5" fill="#5a5a62" stroke="#444" strokeWidth="0.5"/>
    <circle cx="26" cy="12" r="2" fill="#777"/>
    {/* Hook */}
    <line x1="20" y1="16" x2="20" y2="22" stroke="#666" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M16,26 A4,4 0 0,0 24,26" fill="none" stroke="#666" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const ICON_MAP = {
  ...
  scale: ScaleIcon,
  rodStand: RodStandIcon
};

// Equipment data
// nominalMass is the "labeled" mass; actual mass will vary by up to 5% (except massHanger which is exact)
export const EQUIPMENT = [
  {
    ...
    defaultProps: { width: 480, height: 18, leftFootHeight: 0, rightFootHeight: 0, friction: 0.002, nominalMass: 2.0 }
  },
  {
    type: "cart",
    name: "Dynamics Cart",
    category: "Mechanics",
    description: "A ~500g low-friction cart for the dynamics track. Give it a push or release on a tilt to study acceleration. Use a scale to measure exact mass.",
    usage: "Place on track. Shift+click and drag to push. Falls off track ends - real physics!",
    defaultProps: { width: 48, height: 28, nominalMass: 0.5, velocity: 0, velocityY: 0 }
  },
  {
    type: "pulley",
    name: "Pulley",
    ...
    defaultProps: { width: 28, height: 28, nominalMass: 0.05 }
  },
  {
    type: "string",
    name: "String",
  ...
  },
  {
    ...
    category: "Mechanics",
    description: "A 50g mass hanger with a set of precision slotted weights. Adjust the total hanging mass using the slider (50g-500g). These are calibrated masses with exact known values.",
  ...
  },
  {
    ...
    defaultProps: { width: 32, height: 38, direction: "right", nominalMass: 0.2 }
  },
  {
    type: "bubbleLevel",
    name: "Bubble Level",
    ...
    defaultProps: { width: 72, height: 14, nominalMass: 0.08 }
  },
  {
    type: "meterStick",
    name: "Meter Stick",
  ...
  },
  {
    ...
    name: "Digital Scale",
    category: "Tools",
    description: "A precision digital scale for measuring mass. Place objects on the platform to measure their mass in grams. Accurate to 0.1g.",
    usage: "Place in lab. Drag objects onto the scale platform to measure their mass. The display shows the measured mass.",
    defaultProps: { width: 80, height: 40, measuredMass: null }
  },
  {
    type: "rodStand",
    name: "Rod Stand",
    category: "Mechanics",
    description: "A sturdy metal rod stand with a heavy base. Use it to hang a pulley for simple pulley experiments or Atwood machine setups without needing the track.",
    usage: "Place on table or floor. Hang a pulley from the hook at the top. Thread string over the pulley to connect masses.",
    defaultProps: { width: 60, height: 120, nominalMass: 1.5 }
  },
];
